                ...
                <div style={{ marginLeft: '360px',marginTop:'20px' }}>
                    <div className="col-md-7 mt-2">
                        <div className="card" style={{boxShadow:'20px 20px 50px',borderRadius:'20px'}}>
                            <div className="card-header" style={{backgroundColor:'gray',color:'white',fontWeight:'bold',borderRadius:'20px 20px 0px 0px',fontSize:'20px'}}>Job Seeker Registration</div>
